...
bool EtherCatBaseData::dataEditFieldGui() {
	...
	case DataFormat::Type::DECIMAL:
		switch (dataType) {
		case EtherCatData::Type::UINT8_T:	return ImGui::InputScalar("##input", ImGuiDataType_U8, &u8); break;
		case EtherCatData::Type::INT8_T:	return ImGui::InputScalar("##input", ImGuiDataType_S8, &s8); break;
		case EtherCatData::Type::UINT16_T:	return ImGui::InputScalar("##input", ImGuiDataType_U16, &u16); break;
		case EtherCatData::Type::INT16_T:	return ImGui::InputScalar("##input", ImGuiDataType_S16, &s16); break;
		case EtherCatData::Type::UINT32_T:	return ImGui::InputScalar("##input", ImGuiDataType_U32, &u32); break;
		case EtherCatData::Type::INT32_T:	return ImGui::InputScalar("##input", ImGuiDataType_S32, &s32); break;
		case EtherCatData::Type::UINT64_T:	return ImGui::InputScalar("##input", ImGuiDataType_U64, &u64); break;
		case EtherCatData::Type::INT64_T:	return ImGui::InputScalar("##input", ImGuiDataType_S64, &s64); break;
		}
		break;
	case DataFormat::Type::HEXADECIMAL:
		...
		switch (dataType) {
			case EtherCatData::Type::UINT8_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 3, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::INT8_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 3, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::UINT16_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 5, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::INT16_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 5, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::UINT32_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 9, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::INT32_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 9, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::UINT64_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 17, ImGuiInputTextFlags_CharsHexadecimal); break;
			case EtherCatData::Type::INT64_T:	wasEdited = ImGui::InputText("##inputHex", inputString, 17, ImGuiInputTextFlags_CharsHexadecimal); break;
		}
		if (wasEdited) {
	...
	case DataFormat::Type::BINARY:
		...
		switch (dataType) {
			case EtherCatData::Type::UINT8_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 9); break;
			case EtherCatData::Type::INT8_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 9); break;
			case EtherCatData::Type::UINT16_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 17); break;
			case EtherCatData::Type::INT16_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 17); break;
			case EtherCatData::Type::UINT32_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 33); break;
			case EtherCatData::Type::INT32_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 33); break;
			case EtherCatData::Type::UINT64_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 65); break;
			case EtherCatData::Type::INT64_T:	wasEdited = ImGui::InputText("##inputBin", inputString, 65); break;
		}
		if (wasEdited) {
...
bool EtherCatRegisterData::registerEditFieldGui() {
	...
	if (ImGui::InputText("##Index", registerInput, 5, ImGuiInputTextFlags_CharsHexadecimal)) {
...
bool EtherCatEepromData::addressFieldGui() {
	...
	if (ImGui::InputText("##Index", addressInput, 5, ImGuiInputTextFlags_CharsHexadecimal)) {
