	...
	if(ImGui::BeginTabItem("EL7222-0010")){
		if(ImGui::BeginTabBar("Drive")){
			if(ImGui::BeginTabItem("Control")){
				...
				if(ImGui::Button("First Setup")) actuator1->firstSetup();
				ImGui::SameLine();
				ImGui::Text("%s", actuator1->firstSetupProgress.read().c_str());
				if(ImGui::Button("Reset Encoder")) actuator1->resetEncoderPosition();
				ImGui::SameLine();
				ImGui::Text("%s", actuator1->resetEncoderPositionProgress.read().c_str());
				if(ImGui::Button("Upload Parameters")) actuator1->uploadParameters();
				ImGui::SameLine();
				ImGui::Text("%s", actuator1->uploadParameterStatus.read().c_str());
				ImGui::PopID();
				...
				if(ImGui::Button("First Setup")) actuator2->firstSetup();
				ImGui::SameLine();
				ImGui::Text("%s", actuator2->firstSetupProgress.read().c_str());
				if(ImGui::Button("Reset Encoder")) actuator2->resetEncoderPosition();
				ImGui::SameLine();
				ImGui::Text("%s", actuator2->resetEncoderPositionProgress.read().c_str());
				if(ImGui::Button("Upload Parameters")) actuator2->uploadParameters();
				ImGui::SameLine();
				ImGui::Text("%s", actuator2->uploadParameterStatus.read().c_str());
				ImGui::PopID();
				
				ImGui::NewLine();
				if(ImGui::Button("Download Diagnostics")) downloadDiagnostics();
				
				if(ImGui::Button("Read OCT 1")) actuator1->readOCT();
				if(ImGui::Button("Read OCT 2")) actuator2->readOCT();
