...
class Lexium32i : public EtherCatDevice {
public:
	
    DEFINE_ETHERCAT_DEVICE(Lexium32i, "Schneider Electric", "Servo Drives", 0x800005A, 0x16E72)
    ...
    //node input data
	std::shared_ptr<NodePin> digitalOut0Pin;
	...
	std::shared_ptr<NodePin> servoMotorPin;
	std::shared_ptr<NodePin> actualLoadPin;
	std::shared_ptr<NodePin> actualPositionPin;
	std::shared_ptr<NodePin> actualVelocityPin;
	
	std::shared_ptr<NodePin> gpioDevicePin;
	std::shared_ptr<NodePin> digitalIn0Pin;
...
#define QuickstopRectionTypeString \
	{Lexium32i::QuickStopReaction::TORQUE_RAMP, "Torque Ramp", "TorqueRamp"},\
	{Lexium32i::QuickStopReaction::DECELERATION_RAMP, "Deceleration Ramp", "DecelerationRamp"}\

DEFINE_ENUMERATOR(Lexium32i::QuickStopReaction, QuickstopRectionTypeString)


#define InputPinStrings \
	{Lexium32i::InputPin::DI0, "Digital Input 0", "DI0"},\
	{Lexium32i::InputPin::DI1, "Digital Input 1", "DI1"},\
	{Lexium32i::InputPin::DI2, "Digital Input 2", "DI2"},\
	{Lexium32i::InputPin::DI3, "Digital Input 3", "DI3"},\
	{Lexium32i::InputPin::NONE, "Unassigned", "Unassigned"}\

DEFINE_ENUMERATOR(Lexium32i::InputPin, InputPinStrings)
