...
namespace Workspace{
	...
	std::vector<std::shared_ptr<Legato::Prototype>>& getClipboard();
	void pushToClipboard(std::shared_ptr<Legato::Prototype> object);
	void pushToClipboard(std::vector<std::shared_ptr<Legato::Prototype>> objects);
};
