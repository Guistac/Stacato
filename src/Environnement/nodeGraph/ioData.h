...
public:
	...
	bool isBoolValue()				{ return type == BOOLEAN_VALUE; }
	bool isIntegerValue()			{ return type == INTEGER_VALUE; }
	bool isRealValue()				{ return type == REAL_VALUE; }

	bool isSameTypeAs(ioData& other) { return other.type == type; }

	//settings data (with data conversions)
