...
//these work with inheritance/polymorphism, but they are more verbose to use and implement
//when using these, specifying the <template type> is mandatory
//whilst the templated method enumerators can autodetect the type for some functions
